...
def parse_args():
    ...
    parser.add_argument('--checkpoint_path', type=str, default="./checkpoints_oil_sim",
    ...
    parser.add_argument('--wandb_project', type=str, default="grpo-oil-simulator",
    ...
    parser.add_argument('--total_volume', type=float, default=1e6,
...
def main():
    ...
    cmd = [
        ...
        # Добавляем параметры симулятора
